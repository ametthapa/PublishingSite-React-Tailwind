...
const Social= () =>{
    return (
        <div className="flex justify-between py-7 px-14 items-center border-b border-gray-200">
            <div className="flex">
                <div className="cursor-pointer h-10 w-10 mr-2 bg-white rounded-full border border-gray-200 flex justify-center items-center hover:bg-indigo-400 transition ease-in duration-300 hover:text-white">
