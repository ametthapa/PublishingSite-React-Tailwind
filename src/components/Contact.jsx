...
const Contact = () => {
  return (
    <div className="pt-5 pb-20 px-20">
      <p className="font-semibold text-3xl border-b-2 pb-4">
        ...
        <div className="col-span-2">
          <form>
            {Names.map((name) => {
              return (
                <div className="p-2">
                  ...
                  <input
                    type="text"
                    className="border border-gray-100 bg-gray-100 placeholder-gray-500 focus:outline-none p-4 h-9 w-3/4"
            ...
            <div className="p-2">
              ...
              <textarea
                className="border border-gray-100 bg-gray-100 placeholder-gray-500 focus:outline-none p-4 w-3/4"
        ...
        <div className="col-span-1">
          ...
          <div className="">
            ...
            <div className="border-l-4 border-primary py-3 pl-4 mb-6">
              <p>
                <FaPhone className="inline-block text-primary mr-1" />{" "}
                <span className="text-sm">Call : +977-071-541144</span>
              </p>
              <p>
                <MdEmail className="inline-block text-primary mr-1" />{" "}
                <span className="text-sm">
                  Email :info@sunauloshopping.com.np
                </span>
              </p>
            </div>
            ...
            <div className="border-l-4 border-primary py-3 pl-4">
              ...
              <p>
                <MdEmail className="inline-block text-primary mr-1" />{" "}
                <span className="text-sm">
                  Email :admin@sunauloshopping.com.np
                </span>
              </p>
            </div>
          </div>
